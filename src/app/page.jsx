  ...
  let services = [
    {
      ...
      description:
        'Safely remove algae and grime from siding, soffits, trim, stucco, brick, and more—no damage, no striping.',
    },
    {
      title: 'Roof Cleaning',
      description:
        'Low-pressure treatment to remove black streaks and organic growth while protecting shingles and extending roof life.',
    },
    {
      title: 'Concrete & Flatwork',
      description:
        'Driveways, sidewalks, patios, and steps—brightened with the right pressure and professional surface cleaning.',
    },
    {
      title: 'Commercial Exterior Cleaning',
      description:
        'Storefronts, offices, multi-unit properties, entryways, walkways, and common areas—cleaned consistently and professionally.',
    },
  ]
    ...
    <Container className="mt-20 sm:mt-24 lg:mt-32">
        ...
        <div className="flex flex-wrap items-end justify-between gap-6">
          <div>
            ...
            <p className="mt-3 max-w-2xl text-base text-neutral-600">
              Fast quotes, clean communication, and results you can see.
            </p>
          </div>
          <Link
            href="/services"
      ...
      <FadeInStagger faster className="mt-10">
        <div className="grid gap-6 sm:grid-cols-2">
          {services.map((s) => (
            <FadeIn key={s.title}>
              <div className="rounded-3xl border border-neutral-200 bg-white p-8 shadow-sm transition hover:border-neutral-300 hover:shadow-md">
